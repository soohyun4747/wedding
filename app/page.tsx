...
export default function Home() {
        ...
        const [schedules, setSchedules] = useState<ScheduleItem[]>([
                { time: '12:00', description: '하객 맞이 및 안내' },
                { time: '12:30', description: '본식 시작' },
        ]);
	...
	const handleToggleMusic = async () => {
        ...
        const handleAddSchedule = () => {
                const time = prompt('일정 시간을 입력해주세요 (예: 12:30)');
                if (!time) return;
                const description = prompt('일정 내용을 입력해주세요.');
                if (!description) return;

                setSchedules((prev) => [...prev, { time, description }]);
        };
                                ...
                                <div className='max-w-md mx-auto space-y-6'>
                                        <div className='bg-white rounded-2xl shadow-md p-8 text-center'>
                                                ...
                                                <div className='grid grid-cols-7 gap-2 text-sm'>
                                                        {calendar.cells.map((cell, index) => {
                                                                const isWeddingDay = cell === weddingDate.getDate();
                                                                return (
                                                                        <div
                                                                                key={`${cell}-${index}`}
                                        ...
                                        <div className='bg-white rounded-2xl shadow-md p-6'>
                                                <div className='flex items-center justify-between mb-4'>
                                                        <div>
                                                                <p className='text-sm text-gray-500'>예식 일정</p>
                                                        ...
                                                        <button
                                                                ...
                                                                className='text-sm text-white bg-rose-500 px-4 py-2 rounded-lg hover:bg-rose-600 transition-colors'
                                                        >
                                                                일정 추가
                                                        </button>
                                                </div>
					...
					<div className='bg-white rounded-2xl shadow-sm p-6 space-y-4'>
						...
						<div className='flex items-start gap-4'>
							...
							<div className='flex-1'>
								...
								<p className='text-gray-800'>오후 12시 30분</p>
							</div>
						</div>
						<div className='flex items-start gap-4'>
							<div className='text-2xl'>📍</div>
